"""
Adapted from https://github.com/luodhhh/ModernTCN/tree/main
...
class TCN(nn.Module):
    ...
    def __init__(self, configs: NeuralPredictionConfig, n_var):

        super(TCN, self).__init__()
        # hyper param

        self.task_name = 'prediction'
        ...
        self.target_window = configs.pred_length
